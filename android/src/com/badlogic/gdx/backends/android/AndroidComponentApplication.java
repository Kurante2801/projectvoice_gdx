...
// This is a workaround to make AndroidApplication extend ComponentActivity
 ...
 *
 * @author mzechner */
public class AndroidComponentApplication extends ComponentActivity implements AndroidApplicationBase {
    ...
    public void exit () {
        handler.post(new Runnable() {
            @Override
            public void run () {
                AndroidComponentApplication.this.finish();
            }
        });
    }
